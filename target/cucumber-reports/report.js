$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/features/validateSmartBear.feature");
formatter.feature({
  "name": "Validate Smart Bear Functionalities",
  "description": "",
  "keyword": "Feature"
});
